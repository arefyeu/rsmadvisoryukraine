...
?>
	<title>
		<?php
			$current_service = get_service_by_name(str_replace('-',' ', $_GET['name']));
			$service_id = $current_service['service_id'];
			switch ($lang) {
				case 'ua':
					echo "Послуги РСМ Україна | ".$current_service['name'.'_'.$lang];
					break;
				case 'en':
					echo "RSM Ukraine services | ".$current_service['name'.'_'.$lang];
					break;
			}
		?>
	</title>
				...
				<div class="content_grid">
					...
					<div class="main_content_container">
						<div class="service_description">
							<div class="service_title"><h1 class="service__h1"><?php echo $current_service['name'.'_'.$lang] ?></h1></div>
							<?php echo $current_service['description'.'_'.$lang]?>
							<div class="mobile_version_service_reference">
								<?php $subservices = get_subservices_by_service_id($service_id);
								foreach ($subservices as $subservice):?>
									<a href = "/subservice-page/<?php echo str_replace(' ','-',$current_service['name_en']);?>/<?php echo str_replace(' ','-',$subservice['name_en']); add_lang_reference($lang);?>">
										<div class="service_ref_block">
											<?php echo $subservice['name'.'_'.$lang] ?>
						...
						<div class="all_experts_contacts">
							<div class="sticky_sidebar">
								...
								<?php 
									$responsible_experts = get_responsible_experts_by_service_id($service_id);
									...
									<div class="expert_contacts">
										...
										<div class="expert_position" style="color: rgb(63,156,53)"><?php echo $responsible_expert['position'.'_'.$lang] ?></div>
								...
								<div class="make_offer_button_container">
									<a href = "/offer/<?php echo str_replace(' ','-',$current_service['name_en'])."/$lang";?>"><div>
										<?php switch ($lang) {
											case 'ua':
